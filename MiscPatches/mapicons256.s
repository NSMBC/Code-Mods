...
ncp_call(0x020D0E88,8)
ncp_call(0x020D0E90,8)
ncp_call(0x020D0E98,8)
ncp_call(0x020D0EA0,8)
	LDR		R2, [SP, #0x1C]
	ADD		R2, R2, R8					@Add World number (R8) to map-icon coefficient (R2)
	BX		LR
	
ncp_call(0x020D0F08,8)
